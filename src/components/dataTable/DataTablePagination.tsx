...
const DataTablePagination = ({
  ...
  return (
    <div className={styles.pageContainer}>
      ...
      >
        <span>
          <Icon name="doubleLeftArrow" width="24px" height="43px" />
        </span>
      </button>
      <button
        className={styles.pageButton}
      ...
      >
        <span>
          <Icon name="leftArrow" width="24px" height="43px" />
        </span>
      </button>
      ...
      >
        <span>
          <Icon name="rightArrow" width="24px" height="43px" />
        </span>
      </button>
      <button
        className={styles.pageButton}
      ...
      >
        <span>
          <Icon name="doubleRightArrow" width="24px" height="43px" />
        </span>
      </button>
    </div>
  );
